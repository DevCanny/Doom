...
class Levels(Menu):
    ...
    def _create_buttons(self):
        ...
        self.btn_level_5, self.level_5 = button(self.screen, LEVEL_5_NAME, BLACK, BTN_LEVEL_5_POS,
                                                LEVEL_BTN_SIZE[0], LEVEL_BTN_SIZE[1], button_font)
        self.btn_level_custom, self.level_custom = button(self.screen, LEVEL_CUSTOM_NAME, BLACK, BTN_LEVEL_CUSTOM_POS,
                                        LEVEL_BTN_SIZE[0], LEVEL_BTN_SIZE[1], button_font)
    ...
    def _mouse_operations(self):
        ...
        chosen_levels = [
            ...
            self._btns_check(mouse_pos, mouse_click, self.btn_level_custom, BTN_LEVEL_CUSTOM_POS, LEVEL_CUSTOM_NAME, LEVEL_CUSTOM)]
